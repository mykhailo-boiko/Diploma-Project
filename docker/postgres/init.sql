...
ALTER DEFAULT PRIVILEGES IN SCHEMA users GRANT SELECT ON TABLES TO analytics_service;
ALTER DEFAULT PRIVILEGES IN SCHEMA orders GRANT SELECT ON TABLES TO analytics_service;
ALTER DEFAULT PRIVILEGES IN SCHEMA inventory GRANT SELECT ON TABLES TO analytics_service;
ALTER DEFAULT PRIVILEGES IN SCHEMA logistics GRANT SELECT ON TABLES TO analytics_service;
